	...
	<div class="logo_products">
		...
		<div class="w3ls_logo_products_left1">
				<ul class="phone_email">
					<li><i class="fa fa-phone" aria-hidden="true"></i>Hubungi Kami : 081231231123</li>
				</ul>
			</div>
			<div class="w3ls_logo_products_left">
				<h1><a href="index.php">Griya Humayra</a></h1>
			</div>
									...
									<div class="hover14 column">
										<div class="agile_top_brand_left_grid">
											<div class="agile_top_brand_left_grid_pos">
												...
												<span><?php echo number_format($p['hargaafter']/$p['hargabefore']*100)?>%</span>
											</div>
												...
												<figure>
													<div class="snipcart-item block" >
														<div class="snipcart-thumb">
															...
															<h4>Rp<?php echo number_format($p['hargaafter']) ?> <span><?php// echo number_format($p['hargabefore'])?></span></h4>
														</div>
...
<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>Ryzen500</li>
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="#">ryzen12021@gmail.com</a></li>
						<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>+123131</li>
					</ul>
				</div>
