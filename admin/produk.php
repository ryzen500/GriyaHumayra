...
<head>
    ...
    <title>Kelola Produk - GriyaHumayra</title>
										 ...
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
											...
											while($p=mysqli_fetch_array($brgs)){
												...
												<tr>
													...
													<td><a href="editFile.php?id=<?php echo $p['idproduk']?>"><button class="btn btn-success">Edit</button></a></td>
													<td><a href="deleteFile.php?hapus=<?php echo $p['idproduk']?>" name=""><button  onclick="return confirm('Anda yakin ingin menghapus data ?') " class="btn btn-danger">Hapus</button></a></td>
