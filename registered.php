...
<html>
<head>
<title>Griya Humayra - Daftar</title>
<!-- for-mobile-apps -->
	...
	<div class="register">
		<div class="container">
			...
			<div class="login-form-grids">
				...
				<form  name="formInput"  onsubmit="validasiEmail();" method="post">
		...
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>Ryzene500.</li>
